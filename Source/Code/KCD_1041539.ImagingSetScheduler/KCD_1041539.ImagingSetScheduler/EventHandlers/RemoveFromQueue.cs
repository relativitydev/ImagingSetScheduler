...
namespace KCD_1041539.ImagingSetScheduler.EventHandlers
{
	...
	class RemoveFromQueue : PreDeleteEventHandler
	{
		public override Response Execute()
		{
			...
			try
			{
				Database.SqlQueryHelper.RemoveRecordFromQueue(Helper.GetDBContext(-1).GetConnection(), Constant.Tables.IMAIGNG_SET_SCHEDULER_QUEUE, ActiveArtifact.ArtifactID, Helper.GetActiveCaseID());
			}
			catch (Exception ex)
			{
