...
namespace KCD_1041539.ImagingSetScheduler.Helper
{
	public class Constant
	{
		...
		//TODO#Critical: undo this
		public const string IMAGING_SET_SCHEDULER_SUPPORTED_RELATIVITY_VERSION = "9.5.0.0";
		public const string IMAGING_SET_SCHEDULER_SUPPORTED_IMAGING_APPLICATION_VERSION = "9.5.0.0";
