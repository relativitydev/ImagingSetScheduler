...
namespace KCD_1041539.ImagingSetScheduler.Helper
{
	public class Constant
	{
		...
		public const string IMAGING_SET_SCHEDULER_SUPPORTED_RELATIVITY_VERSION = "9.5.314.33";
		public const string IMAGING_SET_SCHEDULER_SUPPORTED_IMAGING_APPLICATION_VERSION = "9.5.314.33";
