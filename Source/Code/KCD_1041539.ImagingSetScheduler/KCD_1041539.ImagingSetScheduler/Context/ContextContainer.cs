...
namespace KCD_1041539.ImagingSetScheduler.Context
{
    public class ContextContainer : IContextContainer
    {
        ...
        public ContextContainer(IDBContext masterDbContext, IServicesMgr servicesMgr, IAPILog logger, IInstanceSettingManager instanceSettingManager, IServicesProxyFactory servicesProxyFactory)
        {
